...
class OSASimulation(object):
        ...
        for b in np.arange(0, self.NumberFBG):
            for f in np.arange(0, len(self.RawData)):
                ...
                if self.InputUnits == 0:
                    ...
                    self.FBGArray["FBG" + str(b + 1)]["x"].append(
                        self.RawData["x"][f] * 1000
                    )
                    self.FBGArray["FBG" + str(b + 1)]["LE11"].append(
                        self.RawData["LE11"][f]
                    )
                    self.FBGArray["FBG" + str(b + 1)]["LE22"].append(
                        self.RawData["LE22"][f]
                    )
                    self.FBGArray["FBG" + str(b + 1)]["LE33"].append(
                        self.RawData["LE33"][f]
                    )
                    self.FBGArray["FBG" + str(b + 1)]["S11"].append(
                        self.RawData["S11"][f] / (10**6)
                    )
                    self.FBGArray["FBG" + str(b + 1)]["S22"].append(
                        self.RawData["S22"][f] / (10**6)
                    )
                    self.FBGArray["FBG" + str(b + 1)]["S33"].append(
                        self.RawData["S33"][f] / (10**6)
                    )
    ...
    def UndeformedFBG(
        ...
        MeanChangeRefractiveIndex,
        FringeVisibility,
        DirectionalRefractiveP11,
        ...
        for i in np.arange(0, self.NumberFBG):
            self.APFBG.append(
                self.FBGOriginalWavel[i] / (2.0 * self.InitialRefractiveIndex)
            )
            ...
            for l in np.arange(
                ...
                for z in np.arange(0, M):
                    ...
                    sig = 2.0 * math.pi * self.InitialRefractiveIndex * (
                        (1.0 / l)
                        - (1.0 / (2.0 * self.InitialRefractiveIndex * self.APFBG[i]))
                    ...
                    kaa = (
                        math.pi
                        * self.FringeVisibility
                        * self.MeanChangeRefractiveIndex
                        / l
                    )
                    # print("Kaa: "+str(kaa))
                    # Gamma Function
    ...
    def DeformedFBG(
        ...
        self.DReflect["reflec"] = np.add(
            self.YReflect["reflec"], self.ZReflect["reflec"]
        )
    ...
    def FBGOutputSum(
        ...
        for b in np.arange(1, self.NumberFBG + 1):
            FBGmaxmin["FBG" + str(b)] = {}
            FBGmaxmin["FBG" + str(b)]["AV-LE11"] = np.mean(
                self.FBGArray["FBG" + str(b)]["LE11"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-LE22"] = np.mean(
                self.FBGArray["FBG" + str(b)]["LE22"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-LE33"] = np.mean(
                self.FBGArray["FBG" + str(b)]["LE33"]
            )
            FBGmaxmin["FBG" + str(b)]["Max-LE11"] = np.max(
                self.FBGArray["FBG" + str(b)]["LE11"]
            )
            FBGmaxmin["FBG" + str(b)]["Max-LE22"] = np.max(
                self.FBGArray["FBG" + str(b)]["LE22"]
            )
            FBGmaxmin["FBG" + str(b)]["Max-LE33"] = np.max(
                self.FBGArray["FBG" + str(b)]["LE33"]
            )
            FBGmaxmin["FBG" + str(b)]["Min-LE11"] = np.min(
                self.FBGArray["FBG" + str(b)]["LE11"]
            )
            FBGmaxmin["FBG" + str(b)]["Min-LE22"] = np.min(
                self.FBGArray["FBG" + str(b)]["LE22"]
            )
            FBGmaxmin["FBG" + str(b)]["Min-LE33"] = np.min(
                self.FBGArray["FBG" + str(b)]["LE33"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-S11"] = np.mean(
                self.FBGArray["FBG" + str(b)]["S11"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-S22"] = np.mean(
                self.FBGArray["FBG" + str(b)]["S22"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-S33"] = np.mean(
                self.FBGArray["FBG" + str(b)]["S33"]
            )
            FBGmaxmin["FBG" + str(b)]["AV-T"] = np.mean(
                self.FBGArray["FBG" + str(b)]["T"]
            )
        ...
        fce = (
            (
                (1 + self.PoissonsCoefficient) * self.DirectionalRefractiveP12
                - (1 + self.PoissonsCoefficient) * self.DirectionalRefractiveP11
            )
            * self.InitialRefractiveIndex**3
        ) / self.YoungsModule
